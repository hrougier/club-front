...
function Sidebar({
  ...
  return (
    <div
      className="text-sidebar-foreground md:block group peer hidden"
      data-state={state}
    ...
    >
      ...
      <div
        ...
        className={cn(
          'w-(--sidebar-width) md:flex fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] duration-200 ease-linear',
          side === 'left'
...
function SidebarRail({ className, ...props }: React.ComponentProps<'button'>) {
  ...
  return (
    <button
      ...
      className={cn(
        'hover:after:bg-sidebar-border sm:flex absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] group-data-[side=left]:-right-4 group-data-[side=right]:left-0',
